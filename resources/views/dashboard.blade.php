				...
				<div class="row row-sm">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">الفواتير غير المدفوعة ({{ \App\Models\Invoices::where('value_Status', 2)->count() }})</p>
										</div>
										<span class="float-right my-auto mr-auto">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<p class="mb-0 tx-12 text-white op-7">الفواتير المدفوعة ({{ \App\Models\Invoices::where('value_Status', 1)->count() }})</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7"> 
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h6 class="mb-3 tx-12 text-white">الفواتير المدفوعة جزئياا</h6>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">	{{ number_format(\App\Models\Invoices::where('value_Status', 3)->sum('total'), 2) }}</h4>
											<p class="mb-0 tx-12 text-white op-7">الفواتير المدفوعة جزئياا ({{ \App\Models\Invoices::where('value_Status', 3)->count() }})</p>
										</div>
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7"> 
