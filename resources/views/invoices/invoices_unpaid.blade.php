...
@section('title')
    Invoices UnPaid - Invoices Program
@stop
@section('css')
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu tx-13">
                                                                        ...
                                                                        <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                                            ...
                                                                            الفاتورة</a>
                                                                        <a class="dropdown-item" href="{{ route('invoices.status_show', ['id' => $invoice->id]) }}">
                                                                            <i class=" text-success fas fa-money-bill"></i>&nbsp;&nbsp;تغير حالةالدفع
                                                                        </a>
