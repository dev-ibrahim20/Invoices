...
@section('title')
    Invoices Archive - Invoices Program
@stop
@section('css')
                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" data-page-length='50' style="text-align: center">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Inv number</th>
                                                <th class="border-bottom-0">Inv Date</th>
                                                <th class="border-bottom-0">Due Date</th>
                                                <th class="border-bottom-0">Product</th>
                                                <th class="border-bottom-0">Category</th>
                                                <th class="border-bottom-0">Descound</th>
                                                <th class="border-bottom-0">Rate present</th>
                                                <th class="border-bottom-0">Rate Value</th>
                                                <th class="border-bottom-0">Total</th>
                                                <th class="border-bottom-0">Status</th>
                                                <th class="border-bottom-0">Notes</th>
                                                <th class="border-bottom-0">Archive Date</th>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <form action="{{ route('invoices.ArchiveDestory', 'test') }}" method="post">
                                    {{ method_field('delete') }}
                                    {{ csrf_field() }}
                            </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <form action="{{ route('invoices.RestoreInvoices', 'test') }}" method="post">
                                        {{ csrf_field() }}
                                </div>
                                <div class="modal-body">
