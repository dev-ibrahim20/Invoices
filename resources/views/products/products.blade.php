...
@section('title')
Products List - Invoices Program
@stop
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Setteing</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Products</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                                ...
                                                <td>{{ $Product->description }}</td>
                                                  <td>
                                                        <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                            ...
                                                            data-description="{{ $Product->description }}" data-section_name="{{ $Product->sections->section_name }}" data-toggle="modal"
